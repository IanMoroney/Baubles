...
public final class BaublesRenderLayer implements LayerRenderer<PlayerEntity> {
	...
	private void dispatchRenders(IBaublesItemHandler inv, PlayerEntity player, RenderType type, float partialTicks) {
