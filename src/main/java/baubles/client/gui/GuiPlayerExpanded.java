...
public class GuiPlayerExpanded {
	...
	public GuiPlayerExpanded(PlayerEntity player)
	{
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		InventoryScreen.drawEntityOnScreen(i + 51, j + 75, 30, (float)(i + 51) - this.oldMouseX, (float)(j + 75 - 50) - this.oldMouseY, this.mc.player);
	}
}
